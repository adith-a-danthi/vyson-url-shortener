...
ALTER TABLE `urls` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT (strftime('%s', 'now'));--> statement-breakpoint
...
ALTER TABLE `urls` ADD `user_id` integer NOT NULL REFERENCES users(id);